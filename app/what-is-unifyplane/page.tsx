...
const mdPath = path.join(process.cwd(), "content/pages/what-is-unifyplane.md");
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return pageMetadata({
    ...
    canonicalPath: "/what-is-unifyplane",
    ogType: "article",
  });
}

export default async function WhatIsUnifyPlanePage() {
  const doc = await loadMarkdownFile(mdPath);
  return (
    <PageShell pathname="/what-is-unifyplane">
